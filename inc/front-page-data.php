	...
	function re_style_get_front_page_defaults() {
		return array(
			...
			'location'   => array(
				...
				'schedule' => array(
					array( 'days' => 'Domenica e Lunedì', 'hours' => 'Chiuso' ),
					array( 'days' => 'Martedì - Venerdì', 'hours' => '09:00 - 13:00 | 15:30 - 20:00' ),
			...
			'contacts'   => array(
				...
				'description' => "Per informazioni, prenotazioni o richieste, contattaci.\nTi invitiamo a seguirci sui nostri canali Social.",
			...
			'faq'        => array(
				...
				'description' => 'Qui trovi le risposte alle domande più comuni su prenotazioni, servizi, shop e assistenza.',
				'items'       => array(
					array( 'question' => 'È necessario prenotare?', 'answer' => "Sì, la prenotazione è consigliata per garantirti l'orario più comodo e ridurre i tempi di attesa, soprattutto nei giorni più richiesti." ),
					array( 'question' => 'Posso ricevere una consulenza prima del servizio?', 'answer' => 'Certo. Prima del servizio valutiamo insieme stile, tipologia di capello o barba e risultato desiderato, così da consigliarti il trattamento più adatto.' ),
					array( 'question' => 'Effettuate servizi per eventi o cerimonie?', 'answer' => "Sì, realizziamo servizi dedicati per eventi speciali, cerimonie e matrimoni, con soluzioni personalizzate in base al look e all'occasione." ),
					array( 'question' => 'Posso acquistare i prodotti anche senza un servizio in salone?', 'answer' => 'Sì, puoi acquistare i prodotti grooming selezionati anche senza prenotare un servizio, per prenderti cura di capelli e barba anche a casa.' ),
					...
					array( 'question' => 'Gli orari cambiano durante i festivi?', 'answer' => 'Sì, nei giorni festivi o in periodi particolari gli orari possono variare. Ti consigliamo di contattarci per avere una conferma aggiornata.' ),
					array( 'question' => 'È possibile richiedere servizi a domicilio?', 'answer' => 'Sì, alcuni servizi possono essere concordati a domicilio, soprattutto per eventi speciali. Disponibilità, costi e modalità vengono definiti in fase di contatto.' ),
					array( 'question' => 'Come posso contattarvi rapidamente?', 'answer' => 'Puoi contattarci rapidamente tramite telefono, email o pulsante WhatsApp presente sul sito, così da ricevere assistenza o fissare un appuntamento.' ),
				),
			),
			'newsletter' => array(
				'label'       => 'Newsletter',
				'title'       => 'Resta aggiornato sul tuo stile',
				'description' => 'Iscriviti per ricevere novità, consigli grooming, promozioni dedicate e aggiornamenti su servizi e prodotti Re Style.',
				'note'        => 'Riceverai comunicazioni informative e promozionali relative a servizi, novità e prodotti Re Style.',
